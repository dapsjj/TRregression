...
if __name__=="__main__":
    ...
    print("generate_year:" + str(generate_year))
    print("generate_week:" + str(generate_week))
    print("keyword_frequency_avg:" + str(keyword_frequency_avg))
    print("keyword_frequency_offet:" + str(keyword_frequency_offet))
    print("importance_degree_g_avg:" + str(importance_degree_g_avg))
    print("importance_degree_g_offet:" + str(importance_degree_g_offet))
    print("adjustment:" + str(adjustment))
    print("R_Square:" + str(R_Square))
    print("Significance_F:" + str(Significance_F))
    print("Coefficients_Intercept:" + str(Coefficients_Intercept))
    print("X_Variable_1:" + str(X_Variable_1))
