...
if __name__=="__main__":
    ...
    #记录系数
    logger.info("---------------------------------------------------------")
    logger.info("keyword_frequency_avg:" + str(keyword_frequency_avg))
    logger.info("keyword_frequency_offet:" + str(keyword_frequency_offet))
    logger.info("importance_degree_g_avg:" + str(importance_degree_g_avg))
    logger.info("importance_degree_g_offet:" + str(importance_degree_g_offet))
    logger.info("adjustment:" + str(adjustment))
    logger.info("R_Square:" + str(R_Square))
    logger.info("Significance_F:" + str(Significance_F))
    logger.info("Coefficients_Intercept:" + str(Coefficients_Intercept))
    logger.info("X_Variable_1:" + str(X_Variable_1))
    logger.info("---------------------------------------------------------")
    closeConn()
